...
export const ENDPOINTS = {
  ...
  /** Deletes a character by id (POST charId + accessToken). */
  CHAR_DELETE: 'https://www.realmofthemadgod.com/char/delete',
  /** Returns AppSettings incl. the current build hash — used for drift detection. */
  APP_INIT: 'https://www.realmofthemadgod.com/app/init?platform=standalonewindows64&key=9KnJFxtTvLu2frXv',
};
