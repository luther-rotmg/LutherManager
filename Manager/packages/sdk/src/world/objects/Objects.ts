...
/**
 * Everything standing on the current map (`Luther.world.objects`).
 *
 ...
 * exposed separately through `Luther.world.projectiles`.
 *
 * Prefer `Luther.enemies` or `Luther.players` when you already know what you're
...
export class Objects {
     ...
     * Compatibility convenience alias for `Luther.enemies.getAll()`.
     */
    static getEnemies(): Enemy[] {
        throw new Error('Must be run inside LutherManager client');
    }

    /** Compatibility convenience alias for `Luther.players.getAll()` (includes you). */
