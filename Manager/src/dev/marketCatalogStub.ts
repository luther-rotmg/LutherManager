...
const SCRIPTS: MarketScript[] = [
  ...
  { id: 2, name: 'Autoaim', author: 'Luther', updatedLabel: 'Mar 14th', description: 'Smart auto-aim with target filtering — ignores invisible and untargetable enemies.', tier: 'free', priceType: 'free', category: 'Survival', tags: ['Free'], isFeatured: true },
  { id: 10, name: 'AutoNexus', author: 'Luther', updatedLabel: 'Mar 14th', description: 'Hybrid autonexus with configurable HP thresholds, status effects, and enemy proximity triggers.', tier: 'free', priceType: 'free', category: 'Survival', tags: ['Free'], isNew: true },
  { id: 11, name: 'Autoloot', author: 'Luther', updatedLabel: 'Mar 14th', description: 'Stand-on-pot auto-pickup. Automatically loots potions and configurable items on contact.', tier: 'free', priceType: 'free', category: 'Looting', tags: ['Free'] },
  ...
  { id: 14, name: 'Godfarming', author: 'Luther', updatedLabel: 'Mar 14th', description: 'Automated godlands farming — walks realm, kills gods, picks up stat pots, nexuses when full or in danger.', tier: 'premium', priceType: 'free', category: 'Farming', tags: ['Premium'], isFeatured: true },
  { id: 13, name: 'Autododge', author: 'Luther', updatedLabel: 'Mar 14th', description: 'Advanced dodge automation — AOE avoidance, tracking projectiles, player speed awareness, and enemy condition detection.', tier: 'premium', priceType: 'free', category: 'Survival', tags: ['Premium'], isFeatured: true },
  ...
  { id: 12, name: 'Auto Pot', author: 'Luther', updatedLabel: 'Mar 14th', description: 'Automatic HP/MP potion consumption with configurable thresholds and smart timing.', tier: 'instanced', priceType: 'monthly', priceGems: 3, perRunGems: 1, runBundles: [{ runs: 5, priceGems: 4 }, { runs: 10, priceGems: 7 }], category: 'Survival', tags: [] },
];
